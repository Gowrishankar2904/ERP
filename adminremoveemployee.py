    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            <div class="col-auto col-lg-3 px-sm-1 px-0" id="sidenav">
                ...
                <div class="col p-4">
                    <center>
                        <h1 class="display-6 fw-normal shadow-sm pb-2">Remove Employee</h1>
                    </center>""")
...
for i in rec:
    ...
    print("""
                        ...
                        <td><input type="text" name="eserial" value="%s" readonly style="width:30px; border:none;"></td>
                            <td>%s</td>
                            <td>%s</td>
                            <td>%s</td>
                            <td>%s</td>
                            ...
                            <td>
                                ...
                                <input class="btn btn-dark px-2" type="submit" name="remove" id="empremove" value="remove">
                            </td>
                            </form>""" % (i[0],i[1], i[2], i[6], i[4]))
...
serial = form.getvalue("eserial")
premove= form.getvalue("remove")

if premove!=None:
    q1="""DELETE from empreg where id="%s" """ %(serial)
    cur.execute(q1)
    conn.commit()
