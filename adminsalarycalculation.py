    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            <div class="col-auto col-lg-3 px-sm-1 px-0" id="sidenav">
                ...
                <div class="col p-4">
                    <center>
                        <h1 class="display-4 fw-normal shadow-sm pb-2">Salary Calculation</h1>
                    </center>
                    <div class="col py-3">
...
for i in rec:
                   ...
                   print(""" <tbody>
                        <tr>
                             ...
                             <td>%s</td>
                             <td>%s</td>
                            <td><img src="%s" height="100px" width="100px"></td>"""%(i[0],i[1],i[3],fn))
                   print("""
                           <td><a href="./view.py?id=%s"><button>calculate</button></a></td>
