...
print("""
                <div class="col p-4">
                    <center>
                        <h1 class="display-4 fw-normal shadow-sm pb-2">Asset History</h1>
                    </center>
                    <div class="col py-3">
                <table class="table table-dark table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Asset_Category</th>
                            <th scope="col">Asset_Description</th>
...
for i in rec:
                   ...
                   print(""" <tbody>
                    ...
                    </tbody>"""%(i[0],i[1],i[2],i[3],i[4],i[5],i[6],i[7],fn,i[10]))
print(""" </table>
            </div>
        </div>
    </div>
