    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            <div class="col-auto col-lg-3 px-sm-1 px-0" id="sidenav">
                ...
                <div class="col p-4">
                    <center>
                        <h1 class="display-6 fw-normal shadow-sm pb-2">Select Employee</h1>
                    </center>""")
...
for i in rec:
    ...
    print("""
                        <tr>
                            ...
                            <td>%s</td>
                            <td>%s</td>
                            <td>%s</td>""" % (i[1], i[2], i[6], i[4]))
    print("""
                            <td>
                                <a href="./admintaskform.py?id=%s" class="btn btn-dark px-3" id="EmpSelect">Select</a>
                            </td>""" % i[0])
print("""
                        </tr>
                    </table>
