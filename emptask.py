...
q1="""select* from task where status="" """
cur.execute(q1)
...
for i in res:
    ...
    print("""
                        ...
                        <td><input type="text" name="status" value="%s" readonly style="width:30px; border:none;"></td>
                            ...
                            <td>%s</td>
                            <td>                            
                                <input type="submit" class="btn btn-dark" name="accept" id="accept" value="Accept">
                            </td>
                            </form>
...
if paccept!=None:
    q2="""update task set status='Inprogress' where id='%s' """ %(pstatus)
    cur.execute(q2)
    conn.commit()

    print("""
    <script>
    alert("Task Inprogress")
    </script>
    """)
